...
class SearchRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'search'), createEmptyInstance: create)
...
class SearchResponse extends $pb.GeneratedMessage {
  factory SearchResponse({
    $core.bool? success,
    $core.String? message,
    $core.Iterable<SearchResult>? data,
  }) {
    final $result = create();
    if (success != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'search'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ..pc<SearchResult>(3, _omitFieldNames ? '' : 'data', $pb.PbFieldType.PM, subBuilder: SearchResult.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<SearchResult> get data => $_getList(2);
}
...
class SearchResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SearchResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'search'), createEmptyInstance: create)
...
class SuggestionResponse extends $pb.GeneratedMessage {
  ...
  SuggestionResponse._() : super();
  factory SuggestionResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SuggestionResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SuggestionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'search'), createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SuggestionResponse clone() => SuggestionResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestionResponse copyWith(void Function(SuggestionResponse) updates) => super.copyWith((message) => updates(message as SuggestionResponse)) as SuggestionResponse;
  ...
  static $pb.PbList<SuggestionResponse> createRepeated() => $pb.PbList<SuggestionResponse>();
  @$core.pragma('dart2js:noInline')
  static SuggestionResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SuggestionResponse>(create);
