...
class UserFilterRequest extends $pb.GeneratedMessage {
  factory UserFilterRequest({
  ...
  UserFilterRequest._() : super();
  factory UserFilterRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserFilterRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserFilterRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UserFilterRequest clone() => UserFilterRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserFilterRequest copyWith(void Function(UserFilterRequest) updates) => super.copyWith((message) => updates(message as UserFilterRequest)) as UserFilterRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UserFilterRequest create() => UserFilterRequest._();
  UserFilterRequest createEmptyInstance() => create();
  static $pb.PbList<UserFilterRequest> createRepeated() => $pb.PbList<UserFilterRequest>();
  @$core.pragma('dart2js:noInline')
  static UserFilterRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserFilterRequest>(create);
  static UserFilterRequest? _defaultInstance;
...
class UserStatusRequest extends $pb.GeneratedMessage {
  factory UserStatusRequest({
    $core.int? id,
  }) {
    final $result = create();
    if (id != null) {
  ...
  UserStatusRequest._() : super();
  factory UserStatusRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserStatusRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserStatusRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UserStatusRequest clone() => UserStatusRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserStatusRequest copyWith(void Function(UserStatusRequest) updates) => super.copyWith((message) => updates(message as UserStatusRequest)) as UserStatusRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UserStatusRequest create() => UserStatusRequest._();
  UserStatusRequest createEmptyInstance() => create();
  static $pb.PbList<UserStatusRequest> createRepeated() => $pb.PbList<UserStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static UserStatusRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserStatusRequest>(create);
  static UserStatusRequest? _defaultInstance;
...
class UserActionResponse extends $pb.GeneratedMessage {
  factory UserActionResponse({
    $core.bool? success,
    $core.String? message,
  }) {
    final $result = create();
  ...
  UserActionResponse._() : super();
  factory UserActionResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserActionResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserActionResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'user'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UserActionResponse clone() => UserActionResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserActionResponse copyWith(void Function(UserActionResponse) updates) => super.copyWith((message) => updates(message as UserActionResponse)) as UserActionResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UserActionResponse create() => UserActionResponse._();
  UserActionResponse createEmptyInstance() => create();
  static $pb.PbList<UserActionResponse> createRepeated() => $pb.PbList<UserActionResponse>();
  @$core.pragma('dart2js:noInline')
  static UserActionResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserActionResponse>(create);
  static UserActionResponse? _defaultInstance;
